...
either \lstinline|cc-by| or \lstinline|cc-by-sa|. Please be aware that, in absence of a choice, we assume \textsc{cc by}.
...
\item All bibliography entires show an \textsc{isbn}, if they have one assigned.
\item All bibliography entires that represent web sites have a \textsc{url} and
  an \emph{access date}.
\item No bibliography entry have duplicate information in \textsc{url} and
  \textsc{doi}.
\end{itemize}
% 
