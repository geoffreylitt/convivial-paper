...
\authorinfo{is a PhD student at MIT in the Software Design Group. His research focuses on programming tools, especially for live programming and end user programming.}
...
To demonstrate the user experience of Wildcard, here's an example of
