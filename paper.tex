...
\begin{Highlighting}[]
  \OperatorTok{\{}
\NormalTok{    fieldName}\OperatorTok{:} \StringTok{"name"}\OperatorTok{,} \CommentTok{// The name of the data field}
...
\NormalTok{    type}\OperatorTok{:} \StringTok{"text"}\OperatorTok{,}      \CommentTok{// The type of the field}
    \CommentTok{// Given the DOM element for the entire listing,}
    \CommentTok{// return the DOM element representing this field}
